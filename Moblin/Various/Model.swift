...
final class Model: NSObject, ObservableObject, @unchecked Sendable {
    ...
    private(set) lazy var chat = ChatProvider(maximumNumberOfMessages: maximumNumberOfChatMessages)
    private(set) lazy var quickButtonChat = ChatProvider(maximumNumberOfMessages: maximumNumberOfInteractiveChatMessages)
    private(set) lazy var externalDisplayChat = ChatProvider(maximumNumberOfMessages: 50)
    ...
    // Additional chat-related properties
